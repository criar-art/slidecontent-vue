...
describe('AppFooter', () => {
  ...
  it('is AppFooter contains credits', () => {
    expect(wrapper.find('.footer a').element.href).toBe('https://github.com/criar-art/slidecontent-vue')
    expect(wrapper.find('.footer a').text()).toBe(`Vue${vueVersion}SlideContent${appVersion}@lucasferreiralimax`)
  })
